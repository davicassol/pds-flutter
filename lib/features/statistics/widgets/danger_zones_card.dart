          ...
          if (provider.topDangerZones.isEmpty)
            Center(
              child: Padding(
                ...
                child: Text("Nenhum histórico nesta região.", style: TextStyle(color: AppColors.textWhite.withOpacity(0.5))),
              ),
            )
          else
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.map_rounded, color: AppColors.iconGrey.withOpacity(0.9), size: 20),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "$count alertas reais",
                  style: TextStyle(fontSize: 12, color: AppColors.textWhite.withOpacity(0.6)),
                ),
              ],
            ),
          ),
          Text(
            "#$position",
            style: const TextStyle(fontSize: 16, color: AppColors.textWhite, fontWeight: FontWeight.w900),
          ),
        ],
      ),
    );
